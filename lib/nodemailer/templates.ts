                    ...
                    <tr>
                        <td align="center" style="padding-bottom: 24px;">
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    <td style="font-size: 28px; font-weight: 800; color: #FFFFFF; letter-spacing: -0.5px; font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
                                        Avatar<span style="color: #6C63FF;">AI</span>
                                    </td>
                                    <td style="padding-left: 10px;">
                                        <span style="background: linear-gradient(135deg, #6C63FF, #9D4EDD); color: #fff; font-size: 10px; font-weight: 700; padding: 3px 8px; border-radius: 20px; letter-spacing: 0.5px;">v2.0</span>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="text-align: center; padding: 28px 20px 0 20px;">
                            <p class="footer-text" style="margin: 0 0 6px 0; font-size: 13px; color: #555; line-height: 1.5;">
                                Built with AI, made for <strong style="color: #6C63FF;">you</strong>.
                            </p>
                            <p class="footer-text" style="margin: 0; font-size: 12px; color: #444;">
